...
### Changes:
- Dropped Direct3D 11/12 backends, the game now exclusively uses OpenGL for graphics, and SDL2 for windowing.
...
- Removed the "Fix Exploits" setting, and merged it into the "Apply Bug Fixes" setting, with it being renamed to "Fix Gameplay Bugs".
...
- Fixed the longstanding issue of certain UI elements being mirrored on the Encore Mode.
...
- Fixed the mouse wheel input potentially not getting registered when it's spinning too fast.
